...
# load data
raw_data = pd.read_csv('StandKnee_1.1.csv', header=0)
dataset = raw_data.values
# X = dataset[:, 0:36].astype(float)
# Y = dataset[:, 36]
X = dataset[0:807, 0:36].astype(float)
Y = dataset[0:807, 36]

encoder_Y = [0]*653 + [1]*83 + [2]*70
...
model.fit(X_train, Y_train, batch_size=32, epochs=60, verbose=1, validation_data=(X_test, Y_test), callbacks=[his])
model.summary()
his.loss_plot('epoch')
